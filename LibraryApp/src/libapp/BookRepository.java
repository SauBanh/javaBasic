...
public class BookRepository {
    ...
    public BookRepository() {
        ...
        books.add(new Book("51573", "The Knight's Sowrd", "Fantasy", null, "F.E. Anvil", 4, 0));
        books.add(new Book("39662", "Time of Night", "Romancy", null, "A.U. Ring", 8, 2));
        books.add(new Book("40831", "Castles Siege", "Historical", null, "N.N. Backsmith", 10, 4));
